    ...
    <div className="flex-1 flex flex-col">
      <header className="bg-stone-900 text-white px-5 py-4 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/admin/students" className="text-sm bg-stone-800 hover:bg-stone-700 px-4 py-2 rounded-xl transition-colors">名冊</Link>
          <Link href="/admin/pickup-slots" className="text-sm bg-stone-800 hover:bg-stone-700 px-4 py-2 rounded-xl transition-colors">時段</Link>
